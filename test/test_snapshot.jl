# Regression: MarketConditions is a true snapshot.
#
# Earlier, get_market_conditions passed market.tier_invest_share (and the
# other dict-valued fields) by reference. Mutating the market after the
# snapshot was taken mutated the snapshot too. Confirmed
