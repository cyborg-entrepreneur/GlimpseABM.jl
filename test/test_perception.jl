...
# Mirrors test_market_conditions.jl design. Guards against the
...
@testset "Perception snapshot isolation (regression class)" begin
    ...
    # objects. This was the bug class for MarketConditions; we
...
@testset "Raw AI tier does not mechanically reshape fixed-state perception" begin
    ...
    visible = Opportunity[
        Opportunity(id="obs_tech", discovered=true, sector="tech", complexity=0.35,
                    ...
                    competition=0.20, market_share=0.30, lifecycle_stage="growing",
        ...
        Opportunity(id="obs_service", discovered=true, sector="service", complexity=0.55,
                    ...
                    competition=0.15, market_share=0.25, lifecycle_stage="mature",
        ...
        Opportunity(id="obs_manufacturing", discovered=true, sector="manufacturing", complexity=0.70,
                    ...
                    competition=0.10, market_share=0.20, lifecycle_stage="emerging",
