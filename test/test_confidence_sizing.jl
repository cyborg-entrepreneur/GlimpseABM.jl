# Regression: confidence × signal_score sizing.
#
# An earlier implementation sized every bet as min(capital · max_fraction,
# opp.capital_requirements), regardless of how confident the agent was or
# how strongly the evaluation scored the opportunity. Sizing should instead
# multiply by (confidence · signal_score). This test locks in that behavior:
