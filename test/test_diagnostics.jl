...
# under one of the earlier dataflow/semantic bugs.
#
...
@testset "Diagnostics" begin
    ...
    @testset "competition rises with concentrated investment" begin
        ...
        # the ~0.7 cap the earlier code hit. Pre-fix value was capped at 0.7;
    ...
    @testset "niche opportunity is visible to creator via created_by override" begin
        ...
        # Discovered starts false; creator sees via created_by override.
